...
\begin{description}
	...
	\item[2.] Using $S^{steady,(0)}$ as initial conditions, we solve 
		...
		applied perturbation is null.  In mathematical form,
	...
	\item[7.] (a) Make sure the input levelset  perturbation is
		...
		representative perturbation factor:
                \begin{eqnarray}
		        \delta\phi^{(k_{power})}=
			\sigma\Delta x \delta\phi^{(k_{power})}
		\end{eqnarray}
	...
	\item[8.] Add the perturbations to the base 
		...
		level set function):
                \begin{eqnarray}
                u^{perturb,(0)}=u^{steady,(0)}+\delta u^{(k_{power})}
                \end{eqnarray}
                \begin{eqnarray}
		T^{perturb,(0)}=T^{steady,(0)}+\delta T^{(k_{power})}
                \end{eqnarray}
                \begin{eqnarray}
		...
		following form:
			...
			\end{array} \right)
                \end{eqnarray}
                \begin{eqnarray}
                S^{perturb,(0)}=S^{steady,(0)}+\delta S^{(k_{power})}
                \end{eqnarray}
...
\begin{eqnarray}
	...
	A \delta S^{(k_{power})}\approx
	A^{2} \delta S^{(k_{power}-1)}\approx\ldots\approx
	A^{k_{power}+1} \delta S^{(0)}
\end{eqnarray}
